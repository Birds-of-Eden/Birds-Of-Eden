/*
	...
	2-19-2025
*/
// Placeholder for additional code or comments
...
class Media {
  constructor({
    ...
    this.createMesh();
    this.createTitle();
    this.createPopup(); // ✅ Add pop-up
    this.addHoverEffect(); // ✅ Add hover effect
    this.onResize();
  }
  ...
  /**
   * ✅ Create a pop-up div for showing full image on hover
   */
  createPopup() {
    ...
    this.popup.style.boxShadow = "0 10px 30px rgba(0, 0, 0, 0.3)";
    ...
    this.popupImage.style.width = "100%";
    this.popupImage.style.height = "100%";
    this.popupImage.style.objectFit = "cover";
  ...
  /**
   * ✅ Add hover effect for showing the pop-up
   */
  addHoverEffect() {
    this.plane.onmouseenter = () => {
