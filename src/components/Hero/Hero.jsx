...
const Hero = () => {
  return (
    <main className="relative">
        ...
        <div className="grid grid-cols-1 items-center gap-8 text-white md:grid-cols-2">
          ...
          >
            <h1 className="mb-3 text-2xl transition-transform duration-500 md:text-5xl">
              <span className="scale-100 transform rounded font-bold text-primary transition-transform duration-500">
                BIRDS OF EDEN
              </span>
              <span>
                {" "}
      ...
      {/* Ballpit Background with Better Adjustment */}
      <div
        style={{
          position: "absolute",
          bottom: "0",
      ...
      >
        <Ballpit
          count={70} // Reduced for a cleaner look
          gravity={0.5} // Softer gravity
          friction={0.85} // Slightly higher friction for natural movement
          wallBounce={0.92} // More controlled bounce
          followCursor={false} // Disabling cursor follow for a cleaner effect
        />
        <div
          style={{
            position: "absolute",
