  ...
  return (
    <div className="relative flex h-[500px] w-full flex-col items-center justify-center overflow-hidden">
      <Circles iconSize={40} radius={radius} >
        <Icons.openai className="h-16 w-16 md:h-[100px] md:w-[100px] shrink-0 rounded-full bg-white/80 p-4 text-[#412991] ring-2 ring-white ring-offset-2 ring-offset-transparent backdrop-blur-sm" />
        <GiDeliveryDrone className="h-16 w-16 md:h-[100px] md:w-[100px] shrink-0 rounded-full bg-white/80 p-4 text-gray-700 ring-2 ring-white ring-offset-2 ring-offset-transparent backdrop-blur-sm" />
        <FaReact className="h-16 w-16 md:h-[100px] md:w-[100px] shrink-0 rounded-full bg-white/80 p-4 text-[#61DAFB] ring-2 ring-white ring-offset-2 ring-offset-transparent backdrop-blur-sm" />
        <SiNextdotjs className="h-16 w-16 md:h-[100px] md:w-[100px] shrink-0 rounded-full bg-white/80 p-4 text-black ring-2 ring-white ring-offset-2 ring-offset-transparent backdrop-blur-sm" />
        <FaPython className="h-16 w-16 md:h-[100px] md:w-[100px] shrink-0 rounded-full bg-white/80 p-4 text-[#3776AB] ring-2 ring-white ring-offset-2 ring-offset-transparent backdrop-blur-sm" />
      </Circles>
    </div>
  );
}
...
const Icons = {
  ...
  openai: () => (
    <svg
      ...
      viewBox="0 0 24 24"
      xmlns="http://www.w3.org/2000/svg"
      className="fill-black dark:fill-white h-16 w-16 md:h-[100px] md:w-[100px]"
    >
