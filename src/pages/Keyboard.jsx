...
const specsMap = [
  { icon: KeyboardIcon, key: "switches", label: "Switches" },
  { icon: Layers, key: "layout", label: "Layout" },
  { icon: Wifi, key: "connectivity", label: "Connectivity" },
  { icon: Gauge, key: "keycaps", label: "Keycaps" },
  { icon: Droplets, key: "lighting", label: "Lighting" },
];
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
          {filteredKeyboards.map((item, idx) => (
            <motion.article
              ...
              className="overflow-hidden rounded-3xl border border-gray-200 bg-white shadow-sm transition hover:-translate-y-1 hover:shadow-xl dark:border-gray-700 dark:bg-gray-800"
            >
              <div className="relative h-64 w-full overflow-hidden bg-gray-100 dark:bg-gray-900">
                <img
                  ...
                  loading="lazy"
                />
                <span className="absolute left-3 top-3 flex items-center gap-1 rounded-full bg-white/90 px-2 py-0.5 text-[10px] font-medium uppercase tracking-wide text-gray-900 shadow dark:bg-gray-900/70 dark:text-white">
